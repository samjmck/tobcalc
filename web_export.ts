...
import { cacheExchangeRates, getSecurity, ECB_HOSTNAME, INVESTING_COM_HOSTNAME } from "./src/data.ts";
...
export {
    IBKRAdapter,
    cacheExchangeRates, getSecurity, ECB_HOSTNAME, INVESTING_COM_HOSTNAME,
